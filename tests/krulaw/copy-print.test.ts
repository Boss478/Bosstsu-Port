...
import { LawDocSchema } from '@/lib/krulaw/validate';
import type { Article, LawDoc } from '@/types/krulaw';
import sampleLawRaw from '@/data/krulaw/laws/sample.json';

// ---------------------------------------------------------------------------
// Fixture: the BUILT sample law JSON (src/data/krulaw/laws/sample.json) —
