// ===========================================================================
// KruLAW L1 — validation contract (cases 7/10/11 of the 11-case checklist).
// validateLawDoc returns one error string per violation ([] = valid); every
// message names the offending item (rules 1–11 per src/lib/krulaw/validate.ts
...
describe('validateLawDoc', () => {
  ...
  // --- SCRUTINY-L2: rule 10 + rule-8 extension (see krulaw-scrutiny-log.md
...
//
// `Chapter.sections` is a GATE-1 follow-up extension (types/krulaw.ts FROZEN).
