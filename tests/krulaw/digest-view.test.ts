// ===========================================================================
// KruLAW digest — chapter-grouping builder (L5 final fix wave).
//
// buildChapterGroups splits the flat มาตราสำคัญ card stream into expandable
// chapter groups using the target law's chapter table (src/data/krulaw/laws/
...
import {
  ...
  type RenderLine,
} from '@/app/(website)/krulaw/digest/digest-view';
...
const article = (key: string, label = `มาตรา ${key}`): RenderLine => ({
  ...
  key,
  label,
  href: `/krulaw/national-education-act-2542#มาตรา-${key}`,
