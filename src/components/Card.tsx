  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <h3
          className={`text-2xl font-bold mb-2 leading-relaxed ${textColor} transition-all duration-300 ease-spring`}
        >
          {title}
        </h3>
      ...
      <div className="absolute bottom-6 right-6 w-10 h-10 rounded-full bg-blue-100 dark:bg-slate-800 text-blue-600 dark:text-blue-400 flex items-center justify-center group-hover:bg-blue-500 dark:group-hover:bg-blue-600 group-hover:text-white transition-all duration-300 ease-spring shadow-sm">
