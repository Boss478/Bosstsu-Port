        ...
        <div className="flex items-center justify-center py-16 px-6">
          <div className="rounded-2xl bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm border border-white/60 dark:border-slate-700/50 shadow-sm p-8 max-w-sm w-full text-center space-y-4">
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl bg-blue-600 text-white font-semibold text-sm hover:bg-blue-700 active:scale-95 transition-[background-color,transform] active:duration-150"
            >
              Try Again
            </button>
          </div>
