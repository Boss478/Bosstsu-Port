    ...
    >
      <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 px-2">
        <div className="text-sm text-zinc-600 dark:text-zinc-400 flex-1 text-center sm:text-left leading-relaxed">
          <p>ไซต์นี้ใช้ข้อมูลการใช้งานเพื่อปรับปรุงประสบการณ์ของคุณ</p>
          <p>
        ...
        <div className="flex gap-2 shrink-0">
          ...
          >
            <span className="block sm:inline">ปฏิเสธ</span>
            <span className="hidden sm:inline">{' / '}</span>
            <span className="block sm:inline">Decline</span>
          </button>
          <button
            onClick={handleAccept}
            className="px-4 py-1.5 text-sm rounded-full bg-blue-600 text-white hover:bg-blue-700 transition-colors"
          >
            <span className="block sm:inline">ยอมรับ</span>
            <span className="hidden sm:inline">{' / '}</span>
            <span className="block sm:inline">Accept</span>
          </button>
        </div>
      </div>
    </div>
