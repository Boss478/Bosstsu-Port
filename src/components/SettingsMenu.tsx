    ...
    <div ref={rootRef} className="relative">
      <button
        ...
        className={`flex items-center justify-center ${
          variant === 'mobile'
            ? 'p-2 min-h-11 min-w-11 rounded-full bg-white/60 dark:bg-slate-900/60 border border-white/60 dark:border-slate-700/50 shadow-lg shadow-blue-100/40 dark:shadow-black/20 hover:bg-white/85 dark:hover:bg-slate-800/85 backdrop-blur-xs transition-transform duration-press active:scale-95'
