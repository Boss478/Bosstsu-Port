  ...
  return (
    <div className="flex flex-col sm:flex-row items-center gap-6 py-2">
      <svg viewBox="0 0 240 240" className="w-44 h-44 shrink-0">
        ...
        <circle cx={cx} cy={cy} r={holeR} className="fill-white dark:fill-slate-800" />
      ...
      <div className="space-y-1.5 w-full max-w-[200px]">
        {slices.map((s, i) => (
          <div key={i} className="flex items-center gap-2 text-xs">
            ...
            <span className="text-zinc-600 dark:text-zinc-400 flex-1 truncate">{s.label}</span>
            ...
            <div className="mt-3 pt-3 border-t border-zinc-200 dark:border-zinc-700">
              <div className="flex items-center justify-between text-xs">
                ...
                <span className="text-zinc-400">
                  {new Date(top5Expenses[0].date).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}
                </span>
              </div>
