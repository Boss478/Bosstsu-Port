              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <ul className="text-zinc-600 dark:text-zinc-400 space-y-3 text-sm">
                    <li><b className="text-blue-500">Practice:</b> Shows answer when wrong. Focuses on words you miss.</li>
              ...
              <div className="space-y-6">
                <div className="border-l-2 border-blue-500 pl-4 py-1">
                  <h4 className="font-bold text-zinc-800 dark:text-zinc-200 flex justify-between">
                    v1.1.1 
                    <span className="text-xs font-normal text-blue-500 bg-blue-100 dark:bg-blue-900/40 px-2 py-1 rounded-full">New Update</span>
                  </h4>
