...
export const WORDS: WordData[] = [
  ...
  },
  {
    ...
    syllables: ["dog"],
    phonemes: ["d", "o", "g"],
    definition: "A common domesticated carnivorous mammal that typically has a long snout and a barking voice.",
  ...
  },
  {
    ...
    syllables: ["fox"],
    phonemes: ["f", "o", "k", "s"],
    definition: "A wild carnivorous mammal of the dog family, known for its bushy tail and cleverness.",
  ...
  },
  {
    ...
    syllables: ["law"],
    phonemes: ["l", "aw"],
    definition: "The system of rules which a particular country or community recognizes as regulating actions.",
  ...
  },
  {
    ...
    syllables: ["saw"],
    phonemes: ["s", "aw"],
    definition: "A hand tool for cutting wood or other materials, typically having a toothed blade.",
  ...
  },
  {
    ...
    syllables: ["spoon"],
    phonemes: ["s", "p", "oo", "n"],
    definition: "An implement consisting of a small, shallow oval bowl with a long handle, used for eating or serving.",
  ...
  // ─── Stage 4 Vowels Additions (5 words) ───
  {
    ...
    syllables: ["cake"],
    phonemes: ["k", "ay", "k"],
    definition: "An item of sweet food made from flour, liquid, eggs, and sugar, baked and decorated.",
  ...
  // ─── B1+ Expansion (12 words for CEFR test depth) ───
  {
    ...
    syllables: ["jour", "ney"],
    phonemes: ["dz", "er", "n", "ee"],
    definition: "An act of traveling from one place to another, especially a long or challenging one.",
