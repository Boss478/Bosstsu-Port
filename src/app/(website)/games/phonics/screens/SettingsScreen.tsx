    ...
    <div className="flex-1 overflow-y-auto overscroll-contain bg-transparent">
      <div className="flex flex-col items-center justify-start px-4 pt-10 pb-36">
        <div className="w-full max-w-md flex items-center gap-4 mb-8">
          ...
          <h1
            className="text-2xl font-bold text-[#1C1C1C] dark:text-[#F7E1A0] tracking-widest"
        ...
        <div className="w-full max-w-md space-y-5">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-2 pt-3 border-t border-white/40 dark:border-slate-700/40">
                <label
                  ...
                  className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest text-left"
                >
                  Speech Voice
                </label>
                <select
          ...
          {showRename && (
            ...
            >
              <div
                className="w-full max-w-sm rounded-3xl glass-heavy border border-white/60 dark:border-slate-800 p-6 shadow-2xl space-y-4"
          ...
          {showDelete && (
            ...
            >
              <div
                className="w-full max-w-sm rounded-3xl glass-heavy border border-white/60 dark:border-slate-800 p-6 shadow-2xl space-y-4 text-center"
                onClick={(e) => e.stopPropagation()}
              >
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 font-medium">
                  This will permanently delete &quot;{save?.name}&quot; and all progress. This
                  cannot be undone.
                </p>
                <div className="flex gap-3">
                  <button
  ...
  return (
    <div className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm border border-white/60 dark:border-slate-700/50 rounded-2xl shadow-sm overflow-hidden">
      <div className="px-4 py-2.5 border-b border-white/60 dark:border-slate-700/50">
        <p className="text-xs font-bold tracking-widest text-[#1C1C1C] dark:text-[#F7E1A0]">
          {title}
        </p>
      </div>
...
function ToggleRow({
  ...
  return (
    <div className="flex items-center justify-between">
      ...
      >
        <div
          className={`w-4 h-4 rounded-full bg-white shadow-sm absolute top-[3px] transition-transform ${value ? 'translate-x-6' : 'translate-x-0.5'}`}
        />
      </button>
    </div>
  );
