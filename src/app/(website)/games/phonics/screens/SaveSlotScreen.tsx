    ...
    <div className="flex-1 overflow-y-auto overscroll-contain bg-gradient-to-b from-[#E0F2FE] via-[#F0FDFA] to-[#FEF3C7] dark:from-[#0B132B] dark:via-[#1B254B] dark:to-[#3E1B5D] min-h-full flex flex-col justify-between">
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-10 max-w-md mx-auto w-full">
        ...
        <div className="mb-10 text-center">
          ...
          <h1
            className="text-4xl font-extrabold text-slate-800 dark:text-[#F7E1A0] tracking-wider uppercase drop-shadow-xs"
            style={{ fontFamily: 'var(--font-mali)' }}
          >
            PHONICS ISLAND
          </h1>
          <p className="mt-2 text-xs font-bold text-slate-500 dark:text-slate-400 tracking-widest uppercase">
            SELECT SAVE FILE
          </p>
        </div>
        ...
        <div className="w-full space-y-4">
          {slots.map((slot) => (
            <div key={slot.slot} className="relative group cursor-pointer">
              <div
              ...
              >
                {slot.empty ? (
                  <div className="flex items-center gap-4 py-2">
                    ...
                    <div>
                      <span className="text-slate-700 dark:text-slate-200 font-bold tracking-wider text-sm block">
                        NEW GAME
                      </span>
                  ...
                  <div className="flex items-center gap-4 w-full">
                    ...
                    <div className="flex-1 space-y-1 overflow-hidden">
                      <div className="flex items-center justify-between">
                        <span
                          className="font-extrabold text-slate-800 dark:text-[#F7E1A0] text-base truncate pr-2"
                          style={{ fontFamily: 'var(--font-mali)' }}
                        >
                          {slot.name}
                        </span>
                      ...
                      <div className="flex flex-wrap items-center gap-x-3 gap-y-0.5 text-[11px] font-bold text-slate-500 dark:text-slate-400">
                        <span className="flex items-center gap-1">
                          <i className="fi fi-sr-wallet text-amber-500 text-xs" /> {slot.coins}
                        </span>
                        <span className="flex items-center gap-1">
                          <i className="fi fi-sr-clipboard-list-check text-slate-400 text-xs" />{' '}
                          {slot.rounds} rounds
                        </span>
                        <span className="flex items-center gap-1">
                          <i className="fi fi-sr-flame text-rose-500 text-xs" /> Best:{' '}
                          {slot.bestStreak}
                        </span>
                      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fade-in">
          <div className="bg-white dark:bg-slate-900 max-w-sm w-full p-6 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-2xl animate-scale-up text-center">
            ...
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
              This action is permanent and cannot be undone. You will lose all coins, streaks, and
              progress!
            </p>
      ...
      {onboardingSlot !== null && (
        ...
        >
          ...
          >
            ...
            <p className="mt-1 text-xs text-slate-400 dark:text-slate-500 font-bold uppercase tracking-wider">
            ...
            <div className="mt-4 space-y-4 text-left">
              ...
              <div className="flex flex-col gap-1.5">
                <label
                  ...
                  className="text-[10px] font-extrabold text-slate-400 dark:text-slate-500 uppercase tracking-widest"
                >
                  Adventurer Name
                </label>
                <input
