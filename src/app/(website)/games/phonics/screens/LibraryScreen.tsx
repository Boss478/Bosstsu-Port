...
export default function LibraryScreen() {
  ...
  const [activeFilter, setActiveFilter] = useState<
    'all' | 'basic' | 'vowels' | 'consonants' | 'blends'
  >('all');
    ...
    <div className="flex-1 overflow-y-auto overscroll-contain bg-transparent min-h-full">
      ...
      {selectedPhoneme &&
        ...
        createPortal(
          ...
          >
            <div
              className="bg-white dark:bg-slate-900 rounded-t-3xl border-t border-slate-200 dark:border-slate-800 p-6 w-full max-w-md animate-slide-up-drawer shadow-2xl relative"
            ...
            >
              ...
              <div className="flex items-start gap-4 mb-6">
                ...
                <div className="flex-1 bg-white/70 dark:bg-slate-900/50 border border-white/60 dark:border-slate-800 p-3.5 rounded-2xl relative shadow-sm">
                  ...
                  <p
                    className="text-xs font-bold text-slate-700 dark:text-slate-200 leading-relaxed text-left"
                    style={{ fontFamily: 'var(--font-mali)' }}
                  >
              ...
              <div className="flex flex-col items-center text-center mb-6">
                ...
                <h2
                  className="text-xl font-extrabold text-slate-800 dark:text-white mt-4"
                  style={{ fontFamily: 'var(--font-mali)' }}
                >
                ...
                <div className="mt-3.5 flex items-center gap-2 bg-white/40 dark:bg-slate-900/40 px-3.5 py-1.5 rounded-full border border-white/40 dark:border-slate-800/80 shadow-3xs">
                  ...
                  <span
                    className="text-xs font-extrabold text-[#C8A44E]"
                    style={{ fontFamily: 'var(--font-mali)' }}
                  >
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                <div className="bg-white/40 dark:bg-slate-900/35 border border-white/40 dark:border-slate-800/60 rounded-2xl p-3.5 text-center">
                  <span className="text-[9px] font-extrabold text-slate-400 dark:text-slate-500 uppercase tracking-widest block mb-0.5">
                    Accuracy
                  </span>
