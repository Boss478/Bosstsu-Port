...
export const SIMILAR_SOUND_GROUPS: SimilarSoundGroup[] = [
  ...
  {
    id: 'labiodental-fricatives',
    title: 'Labiodental Fricatives',
    subtitle: 'f, v',
    icon: 'f',
    color: '#E67E22',
    phonemeIds: ['f', 'v'],
  ...
  {
    id: 'alveolar-fricatives',
    title: 'Alveolar Fricatives',
    subtitle: 's, z',
    icon: 's',
    color: '#5DADE2',
    phonemeIds: ['s', 'z'],
  ...
  {
    id: 'postalveolar-fricatives',
    title: 'Postalveolar & Glottal',
    subtitle: 'ʃ, ʒ, h',
    icon: 'sh',
    color: '#1ABC9C',
    phonemeIds: ['sh', 'zh', 'h'],
  ...
  {
    id: 'dental-fricatives',
    title: 'Dental Fricatives',
    subtitle: 'θ, ð',
    icon: 'th',
    color: '#FF70A6',
    phonemeIds: ['th', 'dh'],
...
// ─── Phoneme → Graphemes (reverse mapping from g2p.ts rules) ─────────────
export const PHONEME_TO_GRAPHEMES: Record<string, string[]> = {
  p: ['p'],
  b: ['b'],
  t: ['t'],
  d: ['d'],
...
export const STAGES: StageData[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { id: 's6-3', title: 'EAR, AIR & OOR', phonemeIds: ['eer', 'air', 'oor'] },
      {
        id: 's6-4',
        title: 'Diphthong Mix',
        phonemeIds: ['oy', 'ow', 'uh', 'uh2', 'eer', 'air', 'oor'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    lessons: [
      ...
      {
        id: 's9-4',
        title: 'Complex Consonant Mix',
        phonemeIds: ['sh', 'zh', 'th', 'dh', 'ch', 'dz'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        phonemeIds: ['ae', 'e', 'p', 'b', 'f', 'v', 'm', 'n', 'i', 'o', 'u', 't', 'd', 's', 'z'],
      },
      {
        id: 's11-4',
...
export const CHALLENGE_TYPES = [
  ...
  },
  {
    id: 'speed-spell',
    title: 'Speed Spell',
    subtitle: 'Spell fast under pressure',
    icon: 'fi fi-sr-stopwatch',
    color: '#FFBA08',
  },
  {
    id: 'syllable-smash',
    title: 'Syllable Smash',
    subtitle: 'Count the syllables',
    icon: 'fi fi-sr-bolt',
    color: '#E67E22',
  },
] as const;
...
export const ACHIEVEMENTS: Record<AchievementId, AchievementData> = {
  ...
  vocab_master: {
    id: 'vocab_master',
    title: 'Vocab Master',
    description: 'Complete all 6 CEFR levels in Vocab tab',
  ...
  streak_10: {
    id: 'streak_10',
    title: 'Streak King',
    description: 'Reach a 10-round streak',
    icon: 'fi fi-sr-flame',
    category: 'progress',
    reward: 15,
  },
  ...
  phoneme_40: {
    ...
    description: 'Master all 40 phonemes',
    icon: 'fi fi-sr-crown',
    category: 'phoneme',
    reward: 50,
  },
  ...
  phoneme_allgold: {
    id: 'phoneme_allgold',
    title: 'Phoneme Platinum',
    description: 'Get 100% on all 40 phonemes',
    icon: 'fi fi-sr-gem',
    category: 'phoneme',
    reward: 100,
  },
  ...
  collector_5: {
    id: 'collector_5',
    title: 'Collector',
    description: 'Unlock 5 companions',
    icon: 'fi fi-sr-users',
    category: 'economy',
    reward: 20,
  },
  millionaire: {
    id: 'millionaire',
    title: 'Millionaire',
    description: 'Earn 1000 phoneme coins total',
  ...
  companion_friend: {
    id: 'companion_friend',
    title: "Companion's Friend",
    description: 'Click the companion 100 times',
  ...
  sort_50: {
    id: 'sort_50',
    title: 'Sort Savant',
    description: 'Sort 50 words correctly',
    icon: 'fi fi-sr-sort-alt',
    category: 'challenge',
    reward: 10,
  },
  rhyme_20: {
    id: 'rhyme_20',
    title: 'Rhyme Lord',
    description: 'Find 20 rhyming pairs',
  ...
  speed_spell_30: {
    id: 'speed_spell_30',
    title: 'Speed Speller',
    description: 'Spell 30 words correctly in Speed Spell',
    icon: 'fi fi-sr-keyboard',
    category: 'challenge',
    reward: 10,
  },
  syllable_50: {
  ...
  challenge_all: {
    ...
    description: 'Complete all 5 challenge types',
...
export const COMPANION_BUBBLE_STYLES: Record<
  CompanionId,
  { style: CompanionBubbleStyle; voice: CharacterVoice }
> = {
  nox: {
    style: {
      accentColor: '#C8A44E',
