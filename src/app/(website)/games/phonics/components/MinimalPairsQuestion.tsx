...
import type { MinimalPairsQuestion as MinimalPairsQuestionType, CompanionId } from '../types';
...
export default function MinimalPairsQuestion({
  question,
  feedback,
  companion,
  speak,
    ...
    <div className="flex flex-col gap-6">
      <div className={QUESTION_CARD_CLASSES}>
        <div
          ...
          onClick={() => playWordAudio(question.word.word)}
        ...
        <p className="text-xs font-bold text-slate-400 dark:text-slate-500 mt-2 uppercase tracking-widest relative z-10">
          {question.direction === 'word-to-ipa'
            ? 'Which IPA matches this word?'
            : 'Which word matches this IPA?'}
        </p>
      </div>
