...
import type { WordAssocQuestion as WordAssocQuestionType, CompanionId } from '../types';
...
interface Props {
  question: WordAssocQuestionType;
...
export default function WordAssocQuestion({
  question,
  feedback,
  companion,
  speak,
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 gap-3.5 max-w-md mx-auto w-full">
        {question.options.map((opt) => (
          ...
          >
            <span>{WORD_CLASS_LABELS[opt] ?? opt}</span>
          </QuestionChoiceButton>
        ))}
      </div>
