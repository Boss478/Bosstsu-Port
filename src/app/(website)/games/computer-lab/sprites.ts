...
export const SPRITE_MAP: Record<string, SpriteData> = {
  cpu: S.CPU_SPRITE,
  monitor: S.MONITOR_SPRITE,
  keyboard: S.KEYBOARD_SPRITE,
  ram: S.RAM_SPRITE,
  hdd: S.HDD_SPRITE,
  mouse: S.MOUSE_SPRITE,
  star_filled: S.STAR_FILLED,
  star_empty: S.STAR_EMPTY,
  heart: S.HEART,
  lock: S.LOCK,
  lightbulb: S.LIGHTBULB,
  magnify: S.MAGNIFY,
  checkmark: S.CHECKMARK,
  computer: S.COMPUTER,
  gear: S.GEAR,
  card: S.CARD,
  input_icon: S.INPUT_ICON,
  output_icon: S.OUTPUT_ICON,
  proc_icon: S.PROC_ICON,
  mem_icon: S.MEM_ICON,
  ...
  robot_arm: S.ROBOT_ARM,
  gpu: S.GPU,
  motherboard: S.MOTHERBOARD,
  ssd: S.SSD,
  usb_drive: S.USB_DRIVE,
  sd_card: S.SD_CARD,
  psu: S.PSU,
  fan: S.FAN,
  cables: S.CABLES,
  cpu_cooler: S.CPU_COOLER,
  professor_idle: S.PROFESSOR_IDLE,
  professor_blink: S.PROFESSOR_BLINK,
  professor_wave: S.PROFESSOR_WAVE,
  professor_sign: S.PROFESSOR_SIGN,
  pong_paddle: S.PONG_PADDLE,
  pong_ball: S.PONG_BALL,
  cat: S.CAT,
  magnifier_icon: S.MAGNIFIER_ICON,
  checklist_icon: S.CHECKLIST_ICON,
  guide_arrow_icon: S.GUIDE_ARROW_ICON,
  certificate_bg: S.CERTIFICATE_BG,
  os_icon: S.OS_ICON,
  app_icon: S.APP_ICON,
  sw_windows: S.SW_WINDOWS,
  sw_macos: S.SW_MACOS,
  sw_linux: S.SW_LINUX,
  sw_android: S.SW_ANDROID,
  sw_ios: S.SW_IOS,
  sw_chromeos: S.SW_CHROMEOS,
  sw_word: S.SW_WORD,
  sw_excel: S.SW_EXCEL,
  sw_photoshop: S.SW_PHOTOSHOP,
  sw_vscode: S.SW_VSCODE,
  sw_chrome: S.SW_CHROME,
  sw_spotify: S.SW_SPOTIFY,
  sw_zoom: S.SW_ZOOM,
  sw_calculator: S.SW_CALCULATOR,
  sw_calendar: S.SW_CALENDAR,
  sw_clock: S.SW_CLOCK,
  sw_minecraft: S.SW_MINECRAFT,
  sw_roblox: S.SW_ROBLOX,
  sw_youtube: S.SW_YOUTUBE,
  sw_discord: S.SW_DISCORD,
  sw_powerpoint: S.SW_POWERPOINT,
  sw_instagram: S.SW_INSTAGRAM,
  sw_tiktok: S.SW_TIKTOK,
  sw_whatsapp: S.SW_WHATSAPP,
