/**
 * LawLib — markdown → LawDoc parser.
 *
 * Grammar (see .agents/plans/lawlib-parser-tdd-spec.md §3):
...
import type { Article, ArticleToken, LawDoc } from '../../types/lawlib';
...
// block of tests/lawlib/parser.test.ts). Cut-line: H1 title + '## N. title'
