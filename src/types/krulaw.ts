/**
 * KruLAW — core data model (FROZEN at GATE 1 — changes need PM + senior sign-off).
 *
 * Produced by `parseLawMarkdown` (src/lib/krulaw/parser.ts), validated by
 * `validateLawDoc` (src/lib/krulaw/validate.ts), emitted as static JSON by
 * `npm run krulaw:build` (scripts/krulaw/build.ts).
 */
