...
const unitInclude = [
  ...
  'tests/krulaw/copy-print.test.ts',
  'tests/krulaw/digest-view.test.ts',
  'tests/krulaw/format.test.ts',
  'tests/krulaw/highlight-store.test.ts',
  'tests/krulaw/normalize.test.ts',
  'tests/krulaw/parser.test.ts',
  'tests/krulaw/validate.test.ts',
  'tests/spike-server-action.test.ts',
  'tests/unit/alphabet-adventure.test.ts',
  'tests/unit/challenge-generators.test.ts',
  'tests/unit/krulaw/reader-settings.test.ts',
  'tests/unit/krulaw/theme-provider.test.tsx',
